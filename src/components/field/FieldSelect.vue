...
<template>
  <div
    ...
    @keydown="onKeydown"
  >
    <span v-if="selectedOption?.color" class="of-field-select__badge" :style="{ background: selectedOption.color }">
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          <span v-if="opt.color" class="of-field-select__badge" :style="{ background: opt.color }">{{ opt.label }}</span>
