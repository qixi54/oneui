...
.of-split-pane__divider {
  ...
  flex-grow: 0 !important;
  position: relative !important;
  background-color: var(--of-color-gray-200, #e5e7eb) !important;
  display: flex !important;
...
.of-split-pane__divider:hover {
  background-color: var(--of-color-gray-400, #9ca3af) !important;
}

/* 分隔条中间的指示线/点 */
.of-split-pane__divider-inner {
  background-color: var(--of-color-gray-400, #9ca3af) !important;
  border-radius: var(--of-radius-full, 9999px) !important;
...
.of-split-pane__divider:hover > .of-split-pane__divider-inner {
  opacity: 1 !important;
  background-color: var(--of-color-gray-600, #4b5563) !important;
}

/* 拖拽中状态 */
.of-split-pane--dragging > .of-split-pane__divider {
  background-color: var(--of-color-primary, #6366f1) !important;
}

.of-split-pane--dragging > .of-split-pane__divider > .of-split-pane__divider-inner {
  opacity: 1 !important;
  background-color: var(--of-color-primary-foreground, #ffffff) !important;
}
